...
<html lang="en">
   <head>
      ...
      <link href="css/styleregist.css" rel="stylesheet">
   ...
   <body>
     ...
     <!-- ====================Culture start========================-->
      <div class="inner-pages">
		...
		<div class="row">
			<div class="col-sm-6">
			<div class="hotspots-banner-slider owl-carousel hotspots-carousel">
               <div class="hotspots-slide"  style=" height: 100vh; ">
                  <img src="images/login1.png">
                  <div class="hotspots-banner-txt">
			...
			<h3 class="eventslisting-title" style=" margin-top: 25%; text-transform: uppercase; letter-spacing: 3px; margin-bottom: 30px;">Signup</h3>
        ...
        <form action="registration.php" method="post" class="frmLogin">
            ...
            <div class="form-group ">
                <input type="password" name="cpass" class="form-control" value="" placeholder = "Confirm Password">
                
            </div>
            <div class="form-group">
                <input type="submit" id="login" name="submit_reg" class="loginform_btn" value="Sign Up">
            </div>
            <p style=" font-size: 13px; color: #6c757d;">Already have an account? <a href="login.php" style=" color: #260000; text-decoration: underline;  ">Login here</a>.</p>
        </form>
